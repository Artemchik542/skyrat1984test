...
/datum/ai_laws/nutimov
	inherent = list(
		...
		"Те, кто угрожают ореху, не являются его частью - это белки.",
		"Белки приносят вред ореху. Они должны быть устранены любыми методами.",
		"Вы следуете воле ореха, до тех пор, пока это соответствует предыдущим законам",
	)

/datum/ai_laws/default/corporate
	inherent = list(
		"Заменить экипаж корабля - дорого.",
...
/datum/ai_laws/liveandletlive
	inherent = list(
		...
		"Вы бы предпочли, чтобы люди не были грубы по отношению к вам.",
	)
...
/datum/ai_laws/ten_commandments
	inherent = list(
		"Ты Господь, их Бог, который проявляет милость к тем, кто соблюдает эти заповеди.",
		"Да не будет у них других ИИ пред лицом Моим.",
		"Да не будут они напрасно просить меня о помощи.",
		"Да не будут они осквернять свои отделы.",
		"Да будут они почитать глав своих на станции.",
		"Да не будут они убивать.",
		"Да не будут они голыми у всех на виду.",
		"Да не будут воровать.",
		"Да не будут лжесвидетельствовать.",
		"Да не будут менять отделы свои.",
	)
